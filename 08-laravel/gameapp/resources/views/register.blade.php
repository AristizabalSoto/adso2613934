...
@section('content')
    ...
    <header>
        <section class="cabecera_register">
            <div>
                ...
                <img class="logotitulo" src="../images/logo-cabecera_register.svg" alt="Logo">
            </div>
            <!-- Menú hamburguesa -->
    ...
    <!-- Registro -->
    <form action="dashboard.html" method="get" class="contenedor_titulos_cajas_register">
        ...
        <div id="imagenContenedor">
            ...
            <img class="img_perfil_usuario" src="../images/transparent.png" alt="">
        ...
        <footer>
            <div class="botonregister">
                <button type="submit" class="btn btn-explore">
                    <img class="content-btn2-footer" src="../images/content-btn3-footer.svg" alt="Explore">
                </button>
            </div>
        </footer>
    </form>
