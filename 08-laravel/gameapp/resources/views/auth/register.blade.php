...
<section class="scroll">
    ...
    <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data"
        ...
        <section class="contenedor_titulo_caja_register">
            ...
            <div class="caja">
                <input type="text" name="document" placeholder="Ingrese su documento" value="{{ old('document') }}"
                    required>
            </div>
        </section>
        <section class="contenedor_titulo_caja_register">
        ...
        <section class="contenedor_titulo_caja_register">
            ...
            <div class="caja">
                <img class="ico-eye" src="{{ asset('images/ico-eye.svg') }}" alt="Show Password">
                <input type="password" class="password" name="password_confirmation" placeholder="Confirme su contraseña" required>
            </div>
        </section>
        {{-- boton de registro --}}
...
<script>
    ...
    document.querySelectorAll('.ico-eye').forEach(eyeIcon => {
        eyeIcon.addEventListener('click', function() {
            ...
            this.src = isPasswordVisible ? '{{ asset('images/ico-eye-closed.svg') }}' : '{{ asset('images/ico-eye.svg') }}';
        });
    });
</script>
